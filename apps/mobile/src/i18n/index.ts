...
import { part as bugReport } from './parts/bugReport';
import { part as changePassword } from './parts/changePassword';
...
const PARTS = [authDashboard, customers, expenses, harvests, labourHarvesters, adminsMore, agents, fuelPumps, attendance, offline, attachment, subscription, bugReport, changePassword];
