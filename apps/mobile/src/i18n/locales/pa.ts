...
export const pa = {
  ...
  enums: {
    ...
    role: { OWNER: 'ਮਾਲਕ', STAFF_ADMIN: 'ਸਟਾਫ਼ ਐਡਮਿਨ' },
  },
  settings: {
    language: 'ਭਾਸ਼ਾ',
    firmName: 'ਫਰਮ ਦਾ ਨਾਮ',
    ...
    offlineEntry: 'ਆਫ਼ਲਾਈਨ ਡਾਟਾ ਐਂਟਰੀ',
    offlineEntryHint:
      'ਆਫ਼ਲਾਈਨ ਹੁੰਦਿਆਂ ਰਿਕਾਰਡ ਜੋੜਨ ਅਤੇ ਬਦਲਣ ਦੀ ਇਜਾਜ਼ਤ ਦਿਓ। ਬਦਲਾਅ ਇਸ ਡਿਵਾਈਸ ਉੱਤੇ ਸੰਭਾਲੇ ਜਾਂਦੇ ਹਨ ਅਤੇ ਮੁੜ ਕਨੈਕਟ ਹੋਣ ਤੇ ਸਿੰਕ ਹੋ ਜਾਂਦੇ ਹਨ। ਮੂਲ ਰੂਪ ਵਿੱਚ ਬੰਦ।',
